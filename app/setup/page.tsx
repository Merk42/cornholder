...
import { BAG_BORDER, BAG_BUTTON, DEFAULT_BUTTON } from "../const/style"
...
export default function Setup() {
    ...
    const handleTeam1NameChange = (event:React.ChangeEvent<HTMLInputElement>) => {
        setLocalTeam1Name(event.target.value);
    }

    const handleTeam2NameChange = (event:React.ChangeEvent<HTMLInputElement>) => {
        ...
        <form className='max-w-3xl px-4 mx-auto h-dvh place-content-center'>
            ...
            <div className={`${BAG_BORDER['base']} ${BAG_BORDER[localTeam1Color]}`}>
                ...
                <div className="flex-1">                                
                    ...
                    <input type='text' className={`${BAG_BUTTON['base']} ${BAG_BUTTON[localTeam1Color]} text-left w-full`} id='team1name' value={localTeam1Name} onChange={handleTeam1NameChange}/>
            ...
            <div className={`${BAG_BORDER['base']} ${BAG_BORDER[localTeam2Color]}`}>
                ...
                <div className="flex-1">                                
                    ...
                    <input type='text' className={`${BAG_BUTTON['base']} ${BAG_BUTTON[localTeam2Color]} text-left w-full`} id='team2name' value={localTeam2Name} onChange={handleTeam2NameChange}/>
            ...
            <div className='text-center mt-4'>
                <button type='button' className={DEFAULT_BUTTON} onClick={handleGameStart} disabled={localTeam1Name === '' || localTeam2Name === ''}>
                    start game
                </button>
            </div>
        </form>
