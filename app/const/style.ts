...
export const BAG_BORDER = {
    'base':'flex flex-wrap border-2  p-2 my-4 shadow-xl/30',
    'red':'border-red-800 bg-red-100 dark:bg-red-800',
    'blue':'border-blue-800 bg-blue-100 dark:bg-blue-800'
}
export const BAG_BUTTON = {
    'base': 'cursor-pointer grow text-center border-2 p-2 rounded-md text-black peer-checked:text-white ',
    'red': 'border-red-800 bg-red-300 peer-checked:bg-red-800',
    'blue': 'border-blue-800 bg-blue-300 peer-checked:bg-blue-800'
}

export const BAG_TOTAL = {
